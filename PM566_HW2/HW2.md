...
I choose to use scatter plot to show the association between FEV and
PM2.5 mass. From the graph above, it’s hard to see a clear association
between FEV and PM2.5 mass. From the line we plotted in our graph, it
has negative but close to zero value for the slope, so there may be
negative association between FEV and PM2.5 mass.
